...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/phdng/KernelPatch1/releases/download/$kernelPatchVersion/kpimg-android",
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/phdng/KernelPatch1/releases/download/$kernelPatchVersion/kptools-android",
